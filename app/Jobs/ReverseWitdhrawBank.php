    ...
    public function handle()
    {
        try {
            ...
            app(NotificationInterface::class)->create([
                'user_id' => $withdrawal->user_id,
                'data' => __("Your withdrawal request of :amount :stockItem to bank :address has been declined.", ['amount' => $withdrawal->amount, 'stockItem' => $withdrawal->stockItem->item, 'address' => $withdrawal->address])
            ]);
