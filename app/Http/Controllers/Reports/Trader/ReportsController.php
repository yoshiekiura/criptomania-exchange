...
class ReportsController extends Controller
{
    ...
    public function __construct(DepositInterface $deposit, StockExchange $model, Deposit $depositModel, WithdrawalInterface $withdrawal, ReportsService $reportsService,DepositBankInterface $depoBank)
    {
