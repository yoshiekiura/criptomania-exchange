        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-primary box-borderless">
                @if($wallet->stockItem->deposit_status == ACTIVE_STATUS_ACTIVE)
                    ...
                    <div class="box-body">
                        {!! Form::open(['route'=>['trader.wallets.deposit.storeBank', $wallet->id], 'method' => 'post', 'class'=>'form-horizontal validator']) !!}
                            ...
                            <div class="form-group">
                                <label for="{{ fake_field('admin_bank_id') }}" class="col-md-2 control-label required">{{ __('Select Bank') }}</label>
                                <div class="col-md-10">
                                  

                                     <select class="form-control" id="{{fake_field('admin_bank_id')}}" data-cval-name="The base item field" data-cval-rules="required" name="{{fake_field('admin_bank_id')}}" placeholder="{{__('Select Bank')}}">
