    ...
    <div class="col-md-8 col-md-offset-2">
        <div class="box box-primary box-borderless">
            ...
            <div class="box-body">
                <table class="table table-striped">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th scope="col"><a href="#" data-id = "{{$depoBank->id}}" data-struck = "{{ get_struck($depoBank->payment_prove) }}"  
                                               data-toggle="modal" data-target="#modal-insert" class="show-struck">{{ $depoBank->payment_prove }}
                                            </a>
                            </th>
                            @endif
                        </tr>
                ...
                <a href="{{ route('reports.trader.deposits-bank', $depoBank->wallet_id) }}" class="btn btn-danger"
                    style="margin-left: 45%; margin-top:10px">Back</a>
            </div>
