                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('trader.wallets.deposit', $wallet->id) }}"><i
                                                                class="fa fa-magic"></i> {{ __('Deposit') }}</a>
                                                    </li>
                                                    @endif
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('reports.trader.deposits-bank', $wallet->id) }}"><i
                                                                class="fa fa-magic"></i>
                                                    ...
                                                    <li>
                                                        <a href="{{ route('reports.trader.deposits', $wallet->id) }}"><i
                                                    ...
                                                    <li>
                                                        <a href="{{ route('trader.wallets.withdrawal', $wallet->id) }}"><i
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('reports.trader.withdrawals', $wallet->id) }}"><i
                                                                class="fa fa-magic"></i>
