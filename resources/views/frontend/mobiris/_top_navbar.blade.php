<nav
    class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent navbar-light">
        ...
        <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
            ...
            <li class="dropdown">
                ...
                <button class="btn btn-light dropdown-toggle"
                    style="color: #FFFFFF;background-color: #ffffff;border-color: #ffffff;width: 100%;" type="button"
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <p class="dropdown-item">
                        {{ __('You have :count notifications',['count' => $userNotifications['count_unread']]) }}</p>
            ...
            <a class="nav-link link text-black display-4" href="{{ route('profile.index') }}"
                style="margin-right:-35px;"><span>{{ Auth::user()->userInfo->full_name }} | </span></a>

            <a class="nav-link link text-black display-4" data-toggle="tooltip" data-placement="bottom" title="Log out"
                href="{{ route('logout') }}"><i class="fas fa-sign-out-alt"></i></a>
            @endauth
        </ul>
    </div>
</nav>