...
<link rel="stylesheet" href="{{asset('glider/dist/css/glide.core.min.css')}}">
<link rel="stylesheet" href="{{asset('glider/dist/css/glide.theme.min.css')}}">
    ...
    <script src="{{asset('glider/dist/glide.min.js')}}"></script>
