                                ...
                                <div class="col-sm-4">
                                    <div class="trade-analysis">
                                        ...
                                        <div style="overflow: hidden"><a
                                                href="{{route('trading-views.show',$post->id)}}"
                                                class="analysis-title">{{$post->title}}</a></div>
                                        <div><i class="fa fa-pencil-square-o"></i> {{$post->first_name}}
                                            {{$post->last_name}}<span style="margin:0 5px;"></span><i
                                                class="fa fa-clock-o"></i> {{$post->created_at}}<span
                                                style="margin:0 5px;"></span><i class="fa fa-comment-o"></i>
                                            {{$post->comments}}</div>
