...
<div class="row">
    ...
    <div class="col-md-6 text-center">
        <ul id="candlestick" class="pagination pagination-sm">
            ...
            <li class="{{ $chartInterval == 15 ? 'disabled' : '' }} page-item"><a data-interval="15" class="page-link"
                    href="javascript:">{{ __('15M') }}</a></li>
            <li class="{{ $chartInterval == 30 ? 'disabled' : '' }} page-item"><a data-interval="30" class="page-link"
                    href="javascript:">{{ __('30M') }}</a></li>
            <li class="{{ $chartInterval == 120 ? 'disabled' : '' }} page-item"><a data-interval="120" class="page-link"
                    href="javascript:">{{ __('2H') }}</a></li>
            <li class="{{ $chartInterval == 240 ? 'disabled' : '' }} page-item"><a data-interval="240" class="page-link"
                    href="javascript:">{{ __('4H') }}</a></li>
