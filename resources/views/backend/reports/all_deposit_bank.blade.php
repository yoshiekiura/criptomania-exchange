                                    ...
                                    <div class="modal fade" id="modal-insert">
                                        <div class="modal-dialog" role="document">
                                            <div class="form-group">
                                                <img src="{{ get_struck($transaction->payment_prove) }}"
                                                    alt="{{ __('Profile Image') }}" id="struck"
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $transaction->amount }} <span
                                                        class="strong">{{ $transaction->item }}</span>
                                                </td>
                                                @if(!$status)
                                                <td>
                                                    <span
                                                ...
                                                <td>
                                                    ...
                                                    <a
                                                        href="{{ route('users.show', $transaction->users_id) }}">{{ $transaction->email }}</a>
                                                    @else
                                                    {{ $transaction->email }}
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a
                                                        href="{{ route('admin.list-bank.show', $transaction->admin_bank_id) }}">{{ $transaction->bank_name }}</a>
                                                    @else
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" data-id="{{$transaction->id}}"
                                                        data-struck="{{ get_struck($transaction->payment_prove) }}"
                                                        data-toggle="modal" data-target="#modal-insert"
                                                        class="show-struck">{{ $transaction->payment_prove }}</a>
                                                    @else
                                                ...
                                                <td class="cm-action">
                                                    <div class="btn-group pull-right">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-stock-pair pull-right">
                                                            ...
                                                            <li>
                                                                <a
                                                                    href="{{ route('admin.users.wallets.editBankBalance', [$transaction->users_id, $transaction->wallet_id,$transaction->id]) }}"><i
