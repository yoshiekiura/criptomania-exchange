                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{ $userRoleManagement->created_at->toFormattedDateString() }}</td>
                                        <td class="text-center">{!! $userRoleManagement->is_active ? '<i
                                                ...
                                                <ul class="dropdown-menu pull-right dropdown-menu-action">
                                                    ...
                                                    <li>
                                                        <a class="confirmation"
                                                            ...
                                                            href="{{ route('user-role-managements.destroy',$userRoleManagement->id) }}"><i
                                                                class="fa fa-trash-o"></i> {{ __('Delete') }}</a>
                                                    </li>
                                                    @if($userRoleManagement->is_active == ACTIVE_STATUS_ACTIVE)
                                                    <li>
                                                        <a data-form-id="ur-{{ $userRoleManagement->id }}"
