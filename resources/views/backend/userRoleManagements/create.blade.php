        ...
        <div class="">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('Create User Role') }}:</h3>
                    <div class="box-tools pull-right">
                        <a href="{{ route('user-role-managements.index') }}"
                            class="btn btn-primary back-button">Back</a>
                    </div>
                </div>
                <div class="box-body">
                    {!! Form::open(['route'=>['user-role-managements.store'], 'method'=>'POST'
                    ,'class'=>'user-role-management-form']) !!}
