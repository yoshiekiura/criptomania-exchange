    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <span class="validation-message cval-error"
                data-cval-error="{{ fake_field('role_name') }}">{{ $errors->first('role_name') }}</span>
        </div>
    </div>
</div>
...
<div class="route-group">
    ...
    <div class="col-md-12">
        <div class="row dc-clear">
            ...
            <div class="route-subgroup col-12">
                <div class="col-lg-3 col-md-12" style="margin-bottom: 20px !important;">
                    <div class="checkbox checkbox-success checkbox-compact">
                        ...
                        <label class="disable-text-select"
                            for="task-{{$name}}-{{$groupName}}">{{ title_case(str_replace('_',' ',$groupName)) }}</label>
                    </div>
                </div>
                    ...
                    <div class="row dc-clear">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="checkbox checkbox-success checkbox-inline checkbox-compact">
                                ...
                                <label class="disable-text-select"
                                    for="list-{{$name}}-{{$groupName}}-{{ $permissionName }}">{{ title_case(str_replace('_',' ',$permissionName)) }}</label>
                            </div>
                        </div>
                        <?php
