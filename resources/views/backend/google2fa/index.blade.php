        ...
        <div class="">
            <div class="login-box">
                <div class="login-box-body text-center">
                    <div class="clearfix">
                        <img src="{{ asset('common/images/g2fa.png') }}" alt="GOOGLE AUTHENTICATION"
                            class="img-responsive img-md cm-center">
                    </div>
                    ...
                    <form action="{{ route('profile.google-2fa.verify') }}" method="post" class="login-form">
                        ...
                        <div class="form-group has-feedback {{ $errors->has('google_app_code') ? 'has-error' : '' }}">
                            ...
                            <span class="validation-message cval-error"
                                data-cval-error="google_app_code">{{ $errors->first('google_app_code') }}</span>
                        </div>
                        <div class="row">
                            <!-- /.col -->
                            <div class="col-xs-12">
