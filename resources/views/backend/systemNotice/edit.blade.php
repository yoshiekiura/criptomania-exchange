            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="{{ route('system-notices.index') }}"
                            class="btn btn-primary back-button">{{ __('Back') }}</a>
                    </div>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-8">
                            {!! Form::model($systemNotice, ['route'=>['system-notices.update',$systemNotice->id],
                            'method' => 'post', 'class'=>'form-horizontal system-notice-form']) !!}
                            @method('PUT')
