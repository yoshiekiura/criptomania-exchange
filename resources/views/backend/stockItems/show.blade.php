        ...
        <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <img src="{{ get_item_emoji($stockItem->item_emoji) }}"
                                                    alt="{{ __('Emoji') }}" class="img-responsive img-sm">
                                                @else
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">{!! __('Transaction report of :stockItem', ['stockItem' => '<strong>'
                                    . $stockItem->item . '</strong>']) !!}</h3>
                        </div>
                        <div class="box-body">
                            <div class="form-horizontal show-form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static">{{ $stockItem->total_deposit }}
                                            {{ $stockItem->item }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static">{{ $stockItem->total_deposit_fee }}
                                            {{ $stockItem->item }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static">{{ $stockItem->total_withdrawal }}
                                            {{ $stockItem->item }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static">{{ $stockItem->total_withdrawal_fee }}
                                            {{ $stockItem->item }}</p>
                                    </div>
                                </div>
                            </div>
