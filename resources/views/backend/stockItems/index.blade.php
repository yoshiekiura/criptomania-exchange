                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <img src="{{ get_item_emoji($stockItem->item_emoji) }}" alt="Item Emoji"
                                                class="img-sm cm-center">
                                            @else
                                        ...
                                        <td class="text-center">{!! $stockItem->is_active ? '<i
                                                class="fa fa-check text-green"></i>' : '<i
                                                class="fa fa-close text-red"></i>' !!}</td>
                                        <td class="text-center">{{ $stockItem->created_at->toFormattedDateString() }}
                                        </td>
                                        ...
                                        <td class="cm-action">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-stock-pair pull-right">
                                                    ...
                                                    <li>
                                                        <a data-form-id="update-{{ $stockItem->id }}"
                                                    ...
                                                    <li>
                                                        <a data-form-id="delete-{{ $stockItem->id }}"
