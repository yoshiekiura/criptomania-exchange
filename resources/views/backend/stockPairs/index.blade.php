                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            {{ $stockPair->stock_item }}/{{ $stockPair->base_stock_item }}</td>
                                        <td class="text-center">{{ $stockPair->stock_item }}
                                            ({{ $stockPair->stock_name }})</td>
                                        <td class="text-center">{{ $stockPair->base_stock_item }}
                                            ({{ $stockPair->base_stock_name }})</td>
                                        <td class="text-center">{{ $stockPair->last_price }}</td>
                                        <td class="text-center">
                                            {!! $stockPair->is_active == ACTIVE_STATUS_ACTIVE ? '<i
                                                class="fa fa-check text-green"></i>' : '<i
                                                class="fa fa-close text-red"></i>' !!}
                                        </td>
                                        <td class="text-center">
                                            {!! $stockPair->is_default == ACTIVE_STATUS_ACTIVE ? '<i
                                                class="fa fa-check text-green"></i>' : '<i
                                                class="fa fa-close text-red"></i>' !!}
                                        </td>
                                        <td class="text-center">{{ $stockPair->created_at->toFormattedDateString() }}
                                        </td>
                                        <td class="cm-action">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a data-form-id="update-{{ $stockPair->id }}"
                                                    ...
                                                    <li>
                                                        <a data-form-id="update-default-{{ $stockPair->id }}"
                                                            data-form-method="PUT"
                                                    ...
                                                    <li>
                                                        <a data-form-id="delete-{{ $stockPair->id }}"
