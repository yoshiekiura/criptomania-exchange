            ...
            <div class="col-sm-8">
                    ...
                    <div class="form-group {{ $errors->has('stock_item_name[]') ? 'has-error' : '' }}">
                        <label for="{{ fake_field('stock_item_id') }}"class="col-md-4 control-label required">{{ __('Exchangeable Item') }}</label>
                            <div class="col-md-8">
                                ...
                                <span class="validation-message cval-error" data-cval-error="stock_item_name[]">{{ $errors->first('stock_item_name[]') }}</span>
                        </div>
                    </div>
                ...
                <div class="form-group {{ $errors->has('base_item_name[]') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        ...
                        <span class="validation-message cval-error" data-cval-error="base_item_name[]">{{ $errors->first('base_item_name[]') }}</span>
                    </div>
                </div>
                ...
                <div class="form-group {{ $errors->has('is_active') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-8">
                        <div class="cm-switch">
                            <input class="cm-switch-input input-active" id="0-active" name="is_active[0]" value="1" checked="checked" type="radio"></input>
                            <label for="0-active" class="cm-switch-label">{{ __('Active') }}</label>

                            <input class="cm-switch-input input-active" id="0-inactive" name="is_active[0]" value="0" type="radio"  ></input>
                ...
                <div class="form-group {{ $errors->has('is_default') ? 'has-error' : '' }}">
                                ...
                                <input class="cm-switch-input input-default"  id="0-default" name="is_default[0]" type="radio" value="1" {{ACTIVE_STATUS_ACTIVE, null}} data-cval-rules="required|integer|in:1,0"></input>'+

                                <label for="0-default" class="cm-switch-label">{{ __('Yes') }}</label>

                                <input class="cm-switch-input input-default" id="0-indefault" name="is_default[0]" type="radio" value="0" checked="checked"></input>'+

                                <label for="0-indefault" class="cm-switch-label">{{ __('No') }}</label>'+


                                </div>
                                <span class="validation-message cval-error" data-cval-error="is_default[]">{{ $errors->first('is_default') }}</span>
                                </div>
                        </div>
                                @endif
