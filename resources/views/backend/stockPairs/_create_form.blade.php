...
<div class="form-group {{ $errors->has('base_item_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        ...
        <span class="validation-message cval-error"
            data-cval-error="{{ fake_field('base_item_id') }}">{{ $errors->first('base_item_id') }}</span>
    </div>
</div>
...
<div class="form-group {{ $errors->has('last_price') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        ...
        <span class="validation-message cval-error"
            data-cval-error="{{ fake_field('last_price') }}">{{ $errors->first('last_price') }}</span>
    </div>
</div>
...
<span>You Dont Have Default Pairs</span>
...
@else
    <div class="col-md-8">
        ...
        <span class="validation-message cval-error"
            data-cval-error="{{ fake_field('is_default') }}">{{ $errors->first('is_default') }}</span>
    </div>
</div>
@endif
