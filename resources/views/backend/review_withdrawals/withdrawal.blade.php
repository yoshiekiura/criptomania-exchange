                            ...
                            <table class="table datatable dt-responsive display nowrap dc-table"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="label label-{{ config('commonconfig.payment_status.' . $reviewWithdrawal->status . '.color_class') }}">{{ payment_status($reviewWithdrawal->status) }}
                                            </span>
                                        </td>
                                        <td>
                                            @if(has_permission('users.show'))
                                            <a
                                                href="{{ route('users.show', $reviewWithdrawal->user_id) }}">{{ $reviewWithdrawal->email }}</a>
                                            @else
