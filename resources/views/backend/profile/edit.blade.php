                ...
                <div class="box-body">
                    ...
                    <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                        <label for="{{ fake_field('first_name') }}"
                            class="col-md-3 control-label required">{{ __('First Name') }}</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                        <label for="{{ fake_field('last_name') }}"
                            class="col-md-3 control-label required">{{ __('Last Name') }}</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                        <label for="{{ fake_field('address') }}"
                            class="col-md-3 control-label">{{ __('Address') }}</label>
                        <div class="col-md-9">
