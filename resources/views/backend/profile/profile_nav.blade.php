<ul class="nav nav-tabs">
    ...
    @if(Auth::user()->user_role_management_id == 2 || Auth::user()->user_role_management_id == 3 )
    <li class="{{is_current_route('profile.create.bank')}}"><a
                    href="{{route('profile.create.bank')}}">{{ __('Create New Bank') }}</a></li>
    @endif
        <!-- <li>{{__('Bank Number')}}</li> -->
</ul>