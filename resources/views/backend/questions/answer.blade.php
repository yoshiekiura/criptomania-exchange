                    ...
                    <div class="box box-primary box-borderless">
                        <div class="box-header with-border">
                            <div class="user-block">
                                <img class="img-circle" src="{{ get_avatar($question->user->avatar) }}"
                                    alt="User Image">
                                <span class="username"><a href="">{{ $question->user->userInfo->full_name }}</a></span>
                                <span
                                    class="description">{{ __('Asked at :time',['time'=>$question->created_at->toDayDateTimeString()]) }}</span>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <div class="box-comment">
                                    ...
                                    <div class="comment-text">
                                        <span class="username">{{ $comment->user->userInfo->full_name }}
                                            <span
                                                class="text-muted pull-right">{{ $comment->created_at->toDayDateTimeString() }}</span>
                                        </span>
                                        <p>{!! $comment->content !!}</p>
                                    </div>
                                </div>
