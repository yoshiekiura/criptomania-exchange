                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a
                                                href="{{ route('users.show', $transaction->user_id) }}">{{ $transaction->email }}</a>
                                            @else
                                            {{ $transaction->email }}
                                            @endif
                                        </td>
                                        ...
                                        @php
                                        $journal =
                                        array_flip(config('commonconfig.journal_type'))[$transaction->journal];
                                        @endphp
                                        <td>
                    ...
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <table class="table table-striped table-bordered mb-5" style="font-size: 12px;">
                                        <thead>
                                            <tr>
                                                <th class="text-center bg-aqua-active" colspan="2">
                                                    {{ __('Summary (:coin)',['coin'=>$coin]) }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($coinSummary as $transactionType => $transaction)
                                            <tr>
                                                <td><strong>{{ title_case(str_replace('-',' ',$journal[$transactionType])) }}</strong>
                                                </td>
