                    ...
                    <div class="row">
                        {{-- <div class="col-sm-4 col-md-3">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li
                                    class="{{is_current_route('admin-settings.edit', 'active', ['admin_setting_type'=>$settingSection])}}">
                        <a
                            href="{{route('admin-settings.edit',['admin_setting_type'=>$settingSection])}}">{{ ucwords(str_replace_last('_',' ',$settingSection)) }}</a>
                        </li>
                        @endforeach
                        </ul>
                    </div> --}}
