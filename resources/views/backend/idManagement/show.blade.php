                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <a data-form-id="approve-{{ $user->user_id }}" data-form-method="PUT"
                                                href="{{ route('admin.id-management.approve', $user->user_id) }}"
                                            ...
                                            <a data-form-id="decline-{{ $user->user_id }}" data-form-method="PUT"
                                                href="{{ route('admin.id-management.decline', $user->user_id) }}"
                                                class="confirmation btn btn-sm btn-danger btn-flat btn-sm-block"
                                                data-alert="{{__('Do you want to decline this ID?')}}">
                                                {{ __('Decline') }}
                                            </a>
                                            @endif
                                        </div>
