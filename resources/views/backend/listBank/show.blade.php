	...
	<div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{!!  __('Details of :listBank', ['listBank' => '<strong>' . $listBank->bank_name . '</strong>']) !!}</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            @if(has_permission('admin.list-bank.index'))
                                  <a href="{{ route('admin.list-bank.index') }}"  class="btn btn-primary btn-sm back-button btn-sm-block">{{ __('View all Bank Name') }}</a>
