                ...
                <div class="settings-profile">
                    <div class="box box-borderless">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ $stockPair->stock_item_abbr }}/{{ $stockPair->base_item_abbr }}
                            </h3>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-xs-6">
                                    <div class="description-block">
                                        ...
                                        <span class="text-green text-bold"><i class="fa fa-caret-up"></i>
                                            {{ $stockPair->change_24 }}%</span>
                                        @elseif($stockPair->change_24 < 0) <span class="text-red text-bold"><i
                                                class="fa fa-caret-down"></i> {{ $stockPair->change_24 }}%</span>
                                            @else
                                            <span class="text-bold text-body"><i class="fa fa-sort"></i>
                                                {{ $stockPair->change_24 }}%</span>
                                            @endif
                                            <br>
