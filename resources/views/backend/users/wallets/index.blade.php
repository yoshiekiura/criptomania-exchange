                            ...
                            <table class="table datatable dt-responsive display nowrap dc-table"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cm-action">
                                            @if( in_array($wallet->item_type,
                                            config('commonconfig.currency_transferable')) )
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('reports.admin.wallets.deposits', ['id' => $wallet->id]) }}"><i
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('reports.admin.wallets.withdrawals', ['id' => $wallet->id]) }}"><i
                                                                class="fa fa-magic"></i>
                                                            {{ __('Withdrawal History') }}</a>
                                                    </li>
                                                    @endif
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('admin.users.wallets.editBankBalance', [$wallet->users_id, $wallet->wallet_id,$wallet->id]) }}"><i
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('reports.admin.wallets.depositsBank', $wallet->id) }}"><i
                                                                class="fa fa-magic"></i>
                                                            {{ __('Deposit Bank Transfer History') }}</a>
                                                    </li>
                                                    @endif
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('admin.users.wallets.edit', ['id' => $wallet->user_id, 'walletId' => $wallet->id]) }}"><i
                                                                class="fa fa-magic"></i> {{ __('Give Amount') }}</a>
                                                    </li>
                                                    @endif
