        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="box box-primary box-borderless">
                <div class="box-header text-center with-border">
                    ...
                    <h3>TEST</h3>
                    <a href="{{ route('reports.admin.all-deposits-bank') }}" class="btn btn-primary btn-sm back-button">{{ __('Back') }}</a>
                </div>
                <div class="box-body">
                    {!! Form::open(['route' => ['admin.users.wallets.updateDepoBank', 'id' => $wallet->user_id, 'walletId' => $wallet->id, 'depositId' => $depositBank->id], 'method' => 'post', 'class'=>'form-horizontal validator']) !!}
                    {{ Form::hidden('base_key', base_key()) }}

                            <input type="hidden" class="form-control" value="{{ $depositBank->id }}" name="deposit_bank_id">
