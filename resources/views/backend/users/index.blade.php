                            ...
                            <table class="table datatable dt-responsive display nowrap dc-table"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{!! $user->is_active ? '<i
                                        ...
                                        <td class="cm-action">
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right dropdown-menu-action-user">
                                                    ...
                                                    <li><a href="{{ route('users.show',$user->id)}}"><i
                                                                class="fa fa-eye"></i> {{ __('Show') }}</a></li>
                                                    <li><a href="{{ route('users.edit',$user->id)}}"><i
                                                                class="fa fa-pencil-square-o fa-lg text-info"></i>
                                                            {{ __('Edit Info') }}</a></li>
                                                    <li><a href="{{ route('users.edit.status',$user->id)}}"><i
                                                                class="fa fa-pencil-square fa-lg text-info"></i>
                                                            {{ __('Edit Status') }}</a></li>
                                                    @endif

                                                    @if(has_permission('admin.users.wallets'))
                                                    <li><a href="{{ route('admin.users.wallets',$user->id)}}"><i
                                                                class="fa fa-list fa-lg text-info"></i>
                                                            {{ __('View Wallets') }}</a></li>
                                                    @endif

                                                    @if(has_permission('reports.admin.open-orders'))
                                                    <li><a href="{{ route('reports.admin.open-orders', $user->id)}}"><i
                                                                class="fa fa-list fa-lg text-info"></i>
                                                            {{ __('View Open Orders') }}</a></li>
                                                    @endif

                                                    @if(has_permission('reports.admin.trades'))
                                                    <li><a href="{{ route('reports.admin.trades', $user->id)}}"><i
                                                                class="fa fa-list fa-lg text-info"></i>
                                                            {{ __('View trade history') }}</a></li>
                                                    @endif
                                                </ul>
                                            </div>
                                        </td>
