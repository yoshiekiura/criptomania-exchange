...
<div class="form-group {{ $errors->has('stock_item_id') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::select(fake_field('stock_item_id'), $stockItems, old('stock_item_id', $rpcPort->stock_item_id), ['class' => 'form-control', 'id' => fake_field('stock_item_id'), 'placeholder' => __('Select Exchangeable Item'), 'data-cval-name' => 'The exchangable item field','data-cval-rules' => 'required']) }}
...
<div class="form-group {{ $errors->has('scheme') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        ...
        <select class="form-control" id="scheme" data-cval-name="The scheme field" data-cval-rules="required|max:255" name="{{ fake_field('scheme') }}">
            ...
            <option value="http" {{ old('scheme', $rpcPort->scheme) == 'http' ? 'selected' : '' }}>http</option>
            <option value="https" {{ old('scheme', $rpcPort->scheme) == 'https' ? 'selected' : '' }}>https</option>
        </select>
...
<div class="form-group {{ $errors->has('host') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('host'),  old('host', $rpcPort->host), ['class'=>'form-control', 'id' => fake_field('host'),'data-cval-name' => 'The host field','data-cval-rules' => 'required', 'placeholder' => __('ex: http://example.com or 127.0.0.1')]) }}
        <span class="validation-message cval-error"
...
<div class="form-group {{ $errors->has('port') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('port'),  old('port', $rpcPort->port), ['class'=>'form-control', 'id' => fake_field('port'),'data-cval-name' => 'The port field','data-cval-rules' => 'required|numeric', 'placeholder' => __('ex: 8332')]) }}
        <span class="validation-message cval-error"
...
<div class="form-group {{ $errors->has('rpc_user') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('rpc_user'),  old('rpc_user', $rpcPort->rpc_user), ['class'=>'form-control', 'id' => fake_field('rpc_user'),'data-cval-name' => 'The RPC User field','data-cval-rules' => 'required', 'placeholder' => __('ex: username')]) }}
        <span class="validation-message cval-error"
...
<div class="form-group {{ $errors->has('rpc_password') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('rpc_password'),  old('rpc_password', $rpcPort->rpc_password), ['class'=>'form-control', 'id' => fake_field('rpc_password'),'data-cval-name' => 'The RPC Password field','data-cval-rules' => 'required', 'placeholder' => __('ex: password')]) }}
        <span class="validation-message cval-error"
...
<div class="form-group {{ $errors->has('network_fee') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('network_fee'),  old('network_fee', $rpcPort->network_fee), ['class'=>'form-control', 'id' => fake_field('network_fee'),'data-cval-name' => 'The Network Fee field','data-cval-rules' => 'required|numeric|escapeInput|between:0, 99999999999.99999999', 'placeholder' => __('ex: 0.0001')]) }}
        <span class="validation-message cval-error"
...
<div class="form-group {{ $errors->has('cert_ca') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('cert_ca'),  old('cert_ca', $rpcPort->cert_ca), ['class'=>'form-control', 'id' => fake_field('cert_ca'),'data-cval-name' => 'The Network Fee field','data-cval-rules' => 'nullable|escapeInput|max:255', 'placeholder' => __('OPTIONAL ex: /root/yourusername/directory/cert_ca.ssl')]) }}
        <span class="validation-message cval-error"
