...
<div class="form-group {{ $errors->has('bank_name') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('bank_name'),  old('bank_name', $bankName->bank_name), ['class'=>'form-control', 'id' => fake_field('bank_name'),'data-cval-name' => 'The Bank Name field','data-cval-rules' => 'required|escapeInput|max:255', 'placeholder' => __('ex: BCA')]) }}
...
<div class="form-group {{ $errors->has('account_number') ? 'has-error' : '' }}">
    ...
    <div class="col-md-8">
        {{ Form::text(fake_field('account_number'),  old('account_number', $bankName->account_number), ['class'=>'form-control', 'id' => fake_field('account_number'),'data-cval-name' => 'The Account Number field','data-cval-rules' => 'required|numeric|escapeInput|between:0.00000001, 99999999999.99999999', 'placeholder' => __('ex: Your Account Number')]) }}
