...
<div class="login-box">
    <div class="login-logo">
        ...
        <a href="{{url('/') }}"><img style="width: 40px;height: 40px; margin-top: -10px"
    ...
    <div class="login-box-body">
        ...
        <div class="clearfix link-after-form">
            ...
            <a href="{{ route('verification.form') }}"
                class="text-center pull-right link-underline">{{ __('Get verification email') }}</a>
            @endif
        </div>
    </div>
    <!-- /.login-box-body -->
    ...
    <div class="flex-c-m">
        <a href="#" class="login100-social-item bg1">
            <img src="{{asset('frontend/images/icons/facebook.png')}}">
        </a>

        <a href="#" class="login100-social-item bg2">
            <img src="{{asset('frontend/images/icons/twitter.png')}}">

        </a>

        <a href="#" class="login100-social-item bg3">
            <img src="{{asset('frontend/images/icons/google.png')}}">
        </a>
    </div>
</div>
@endsection
